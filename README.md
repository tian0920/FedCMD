...
<ul>
  ...
  <li><strong>Local Layer Selection:</strong> Based on the criteria of layer selection, each edge client selects a personalized layer from their model during the training.</li>
